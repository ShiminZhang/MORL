...
def main():
    ...
    from src.environments import ScalarRewardWrapper, SteerableHumanoidWrapper, SteerableWalkerWrapper, make_dm_control_walker, make_dm_control_hopper, make_dm_control_humanoid
